 ...
 *
 * @author tag
 * @version $Id: UnitsFormat.java 13014 2010-01-16 09:08:07Z tgaskins $
 */
public class UnitsFormat extends AVListImpl
{
    ...
    /**
     * Specifies the units in which to display altitude values. Units subsequently formatted by the instance are converted
     * from meters to the desired units prior to formatting.
     *
     * @param altitudeUnits the desired altitude units. See {@link #UnitsFormat(String, String, boolean)} for the list of
     *                    those available.
     *
     * @throws IllegalArgumentException if <code>lengthUnits</code> is null.
     */
    ...
    public String terrainHeight(double metersElevation, double verticalExaggeration)
    {
        ...
        return String.format(this.getLabel(LABEL_TERRAIN_HEIGHT) + " (ve %3.1f): %,6d %s", verticalExaggeration,
