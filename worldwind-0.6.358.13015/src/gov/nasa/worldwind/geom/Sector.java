...
public class Sector implements Cacheable, Comparable<Sector>, Iterable<LatLon>
{
    ...
    /**
     * Creates a new <code>Sector</code> and initializes it to the angles resulting from the
     * given {@link java.awt.geom.Rectangle2D} in degrees lat-lon coordinates where x corresponds to longitude
     * and y to latitude. The resulting geographic angles are assumed to be normalized to +/- 90 degrees
     * latitude and +/- 180 degrees longitude, but this method does not verify that.
     *
    ...
    /**
     * Returns a {@link java.awt.geom.Rectangle2D} corresponding to this Sector in degrees lat-lon coordinates
