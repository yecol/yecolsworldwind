    ...
    private static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        private void setupAnnotations()
        {
                ...
                Position.fromDegrees(40, -116, 0), Font.decode("Serif-BOLD-18"), Color.DARK_GRAY)
            {
                public void doDraw(DrawContext dc, int width, int height, double opacity, Position pickPosition)
                {
                    ...
                    FrameFactory.drawShape(dc, FrameFactory.SHAPE_RECTANGLE, insetBounds.width + 6,
                    ...
                    if(freeBounds.height > 0)
                    {
                        ...
                        FrameFactory.drawShape(dc, FrameFactory.SHAPE_ELLIPSE, freeBounds.width,
        ...
        private void updateControlPanel()
        {
            if(this.currentAnnotation != null)
            {
                ...
                this.cbAdjustWidth.setSelected(this.currentAnnotation.getAttributes()
                        .getAdjustWidthToText().equals(Annotation.SIZE_FIT_TEXT));
                ...
                if (currentAnnotation.getAttributes().getFrameShape().equals(FrameFactory.SHAPE_RECTANGLE))
                    cbShape.setSelectedIndex(0);
                else if (currentAnnotation.getAttributes().getFrameShape().equals(FrameFactory.SHAPE_ELLIPSE))
                    cbShape.setSelectedIndex(1);
                else
                    cbShape.setSelectedIndex(2);

                if (currentAnnotation.getAttributes().getLeader().equals(FrameFactory.LEADER_TRIANGLE))
                ...
                if (currentAnnotation.getAttributes().getImageSource() != null)
                {
                    ...
                    if(image.equals(IMAGE_EARTH.getPowerOfTwoImage())) this.cbImage.setSelectedIndex(1);
                    else if(image.equals(IMAGE_NASA.getPowerOfTwoImage())) this.cbImage.setSelectedIndex(2);
                    else if(image.equals(IMAGE_WWJ_SPLASH.getPowerOfTwoImage())) this.cbImage.setSelectedIndex(3);
                ...
                if (imageRepeat.equals(Annotation.IMAGE_REPEAT_NONE)) this.cbImageRepeat.setSelectedIndex(0);
                else if (imageRepeat.equals(Annotation.IMAGE_REPEAT_X)) this.cbImageRepeat.setSelectedIndex(1);
                else if (imageRepeat.equals(Annotation.IMAGE_REPEAT_Y)) this.cbImageRepeat.setSelectedIndex(2);
                else if (imageRepeat.equals(Annotation.IMAGE_REPEAT_XY)) this.cbImageRepeat.setSelectedIndex(3);
        ...
        private void updateAnnotation()
        {
            if(this.currentAnnotation != null && !this.suspendUpdate)
            {
                ...
                {
                    case 0 : {this.currentAnnotation.getAttributes().setTextAlign(AVKey.LEFT); break;}
                    case 1 : {this.currentAnnotation.getAttributes().setTextAlign(AVKey.CENTER); break;}
                    case 2 : {this.currentAnnotation.getAttributes().setTextAlign(AVKey.RIGHT); break;}
                }
                switch (cbTextEffect.getSelectedIndex())
                {
                    case 0 : {this.currentAnnotation.getAttributes().setEffect(AVKey.TEXT_EFFECT_NONE); break;}
                    case 1 : {this.currentAnnotation.getAttributes().setEffect(AVKey.TEXT_EFFECT_SHADOW); break;}
                    case 2 : {this.currentAnnotation.getAttributes().setEffect(AVKey.TEXT_EFFECT_OUTLINE); break;}
                }
                ...
                switch (cbImage.getSelectedIndex())
                {
                    ...
                    case 1: currentAnnotation.getAttributes().setImageSource(IMAGE_EARTH.getPowerOfTwoImage()); break;
                    case 2: currentAnnotation.getAttributes().setImageSource(IMAGE_NASA.getPowerOfTwoImage()); break;
                    case 3: currentAnnotation.getAttributes().setImageSource(IMAGE_WWJ_SPLASH.getPowerOfTwoImage()); break;
