...
/**
 * @author Paul Collins
 * @version $Id: PlaceNameService.java 12869 2009-12-09 05:13:27Z tgaskins $
 */
public class PlaceNameService
{
    ...
    public java.net.URL createServiceURLFromSector(Sector sector) throws java.net.MalformedURLException
    {
        ...
        if(addVersionTag)
            sb.append("version=1.0.0&TypeName=").append(dataset);   //version=1.0.0  is needed when querying a new wfs server
        else
    ...
    public final Extent getExtent(DrawContext dc)
    {
        ...
        return dc.getGlobe().computeBoundingCylinder(dc.getVerticalExaggeration(), this.maskingSector);
    }
