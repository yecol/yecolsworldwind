 ...
 * @version $Id: UTMBaseGraticuleLayer.java 12869 2009-12-09 05:13:27Z tgaskins $
 */
public class UTMBaseGraticuleLayer extends AbstractGraticuleLayer
{
    ...
    protected Position computePosition(int zone, char hemisphere, double easting, double northing)
    {
        return zone > 0 ?
    ...
    protected Position computePositionFromUTM(int zone, char hemisphere, double easting, double northing)
    {
        try
        {
    ...
    protected Position computePositionFromUPS(char hemisphere, double easting, double northing)
    {
        try
        {
    ...
    protected class MetricScaleSupport
    {
        ...
        public void computeZone(DrawContext dc)
        {
            try
            {
                ...
                if (centerPos != null)
                {
                    if (centerPos.latitude.degrees <= UTM_MAX_LATITUDE && centerPos.latitude.degrees >= UTM_MIN_LATITUDE)
                    {
        ...
        public void computeMetricScaleExtremes(int UTMZone, char hemisphere, GridElement ge, double size)
        {
        ...
        public void selectRenderables(DrawContext dc)
        {
            try
            {
                ...
                {
                    UPSCoord UPS = UPSCoord.fromLatLon(centerPos.getLatitude(), centerPos.getLongitude(), dc.getGlobe());
    ...
    protected ArrayList<SquareZone> createSquaresGrid(int UTMZone, char hemisphere, Sector UTMZoneSector,
    ...
    private class SquareSector
    {
        ...
        public SquareSector(int UTMZone, char hemisphere, Sector UTMZoneSector, double SWEasting,
        ...
        {
            return globe.computeBoundingCylinder(ve, this.boundingSector);
        }
    ...
    protected class SquareZone extends SquareSector
    {
        ...
        public SquareZone(int UTMZone, char hemisphere, Sector UTMZoneSector, double SWEasting,
            double SWNorthing, double size)
        {
    ...
    protected class SquareGrid extends SquareSector
    {
        ...
        public SquareGrid(int UTMZone, char hemisphere, Sector UTMZoneSector, double SWEasting,
            double SWNorthing, double size)
        {
            super(UTMZone, hemisphere, UTMZoneSector, SWEasting, SWNorthing, size);
        }
