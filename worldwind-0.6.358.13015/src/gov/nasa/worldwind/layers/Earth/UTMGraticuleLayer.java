 ...
 * @version $Id: UTMGraticuleLayer.java 12869 2009-12-09 05:13:27Z tgaskins $
 */
public class UTMGraticuleLayer extends UTMBaseGraticuleLayer
{
    ...
    protected class GraticuleTile
    {
        ...
        public GraticuleTile(Sector sector)
        {
            ...
            this.hemisphere = this.sector.getCentroid().latitude.degrees > 0 ? 'N' : 'S';
        }

        public Extent getExtent(Globe globe, double ve)
        {
            return globe.computeBoundingCylinder(ve, this.sector);
        }
        ...
        private void createRenderables()
        {
            ...
            if (this.hasLabel())
            {
                String label = "" + this.zone + this.hemisphere;
                GeographicText text = new UserFacingText(label, new Position(this.sector.getCentroid(), 0));
