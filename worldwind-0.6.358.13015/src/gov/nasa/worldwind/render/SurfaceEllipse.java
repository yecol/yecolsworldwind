...
/**
 * @author dcollins
 * @version $Id: SurfaceEllipse.java 12798 2009-11-17 20:14:14Z dcollins $
 */
public class SurfaceEllipse extends SurfaceConcaveShape
{
    ...
    {
        Iterable<? extends Sector> sectors = this.computeBoundingSectors(dc.getGlobe());
        sectors = getSurfaceShapeSupport().adjustSectorsByBorderWidth(
    ...
    protected Iterable<? extends Sector> computeBoundingSectors(Globe globe)
    {
        ...
        return java.util.Arrays.asList(Sector.splitBoundingSectors(globe, this.center, radius));
    }
