...
/**
 * @author dcollins
 * @version $Id: ToolTipRenderer.java 12644 2009-09-24 17:31:49Z dcollins $
 */
public class ToolTipRenderer
{
    ...
    {
        java.awt.Color outlineColor = javax.swing.UIManager.getColor("ToolTip.foreground");
        double outlineWidth = 1;
        java.awt.Insets insets;

        javax.swing.border.Border border = javax.swing.UIManager.getBorder("ToolTip.border");
        if (border instanceof javax.swing.border.LineBorder)
        {
            outlineColor = ((javax.swing.border.LineBorder) border).getLineColor();
            outlineWidth = ((javax.swing.border.LineBorder) border).getThickness();
        }
        ...
        return new ToolTipAttributes(
            javax.swing.UIManager.getFont("ToolTip.font"),
    ...
    protected void beginRendering(DrawContext dc, OGLStackHandler stackHandler)
    {
        ...
        stateSupport.setEnableColor(true);
        stateSupport.setColorMode(OGLStateSupport.COLOR_PREMULTIPLIED_ALPHA);

        int attribMask = stateSupport.getAttributeBits()
    ...
    protected void drawToolTipInterior(DrawContext dc, double width, double height, ToolTipAttributes attributes)
    {
        ...
        this.setDrawColor(dc, attributes.getInteriorColor(), attributes.getInteriorOpacity());
    ...
    protected void drawToolTipOutline(DrawContext dc, double width, double height, ToolTipAttributes attributes)
    {
        ...
        this.setDrawColor(dc, attributes.getOutlineColor(), attributes.getOutlineOpacity());
    ...
    protected void setDrawColor(DrawContext dc, java.awt.Color color, double opacity)
    {
    ...
    protected java.awt.geom.Point2D computeTextTranslation(DrawContext dc, java.awt.geom.Rectangle2D textBounds,
        java.awt.Insets insets)
    {
        // TODO: that's what the javadoc says, but the values seem to contradict. make sure you understand this.

        // The text bounds are assumed to come from the return value of a call to TextRenderer.getBounds(). The bounds
        // then will put the origin in the upper left hand corner, with the y axis increasing downward. The y
