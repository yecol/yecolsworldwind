...
/**
 * @author tag
 * @version $Id: SARTrackExtensionTool.java 11497 2009-06-08 19:11:50Z dcollins $
 */
public class SARTrackExtensionTool implements MouseListener, PositionListener, PropertyChangeListener
{
    ...
    protected SARPosition computeNextTrackPosition()
    {
        ...
        LatLon nextLocation = LatLon.rhumbEndPosition(lastPosition.getLatLon(), heading, angularDistance);
