...
/**
 * @author tag
 * @version $Id: AnalysisPanel.java 12876 2009-12-09 21:48:41Z dcollins $
 */
...
//                System.out.println("AnalysisPanel.propertyChange() for " + propertyChangeEvent.getPropertyName() + " from " + propertyChangeEvent.getSource());
    ...
    private class ViewState
    {
        ...
        public ViewState(OrbitView view, Angle referenceHeading, Position referencePosition)
        {
            ...
            this.relativeCenterLocation = view.getCenterPosition().subtract(referencePosition).getLatLon();
        }
...
//    }
    ...
    protected void doGetRestorableState(RestorableSupport rs, RestorableSupport.StateObject context)
    {
        ...
        if (this.examineViewState != null)
        {
            ...
            rs.addStateValueAsDouble(context, "examineRelativeHeading", this.examineViewState.relativeHeading.getDegrees());
