...
public class ViewInputAttributes
{
    ...
    public static final String VIEW_RESET_HEADING_PITCH = "gov.nasa.worldwind.ViewResetHeadingPitch";
    ...
    private static final ActionAttributes.KeyAction DEFAULT_RESET_HEADING_PITCH_KEY_ACT =
        new ActionAttributes.KeyAction(KeyEvent.VK_R, ActionAttributes.KeyAction.KA_DIR_X, 1);
    public static final ActionAttributes.KeyAction[] resetHeadingPitchEvents =
    {
        DEFAULT_RESET_HEADING_PITCH_KEY_ACT
    };
    // Reset Heading and Pitch
    ...
    public static final double DEFAULT_MOUSE_HORIZONTAL_TRANSLATE_MIN_VALUE = 0.00001; // Speed in degrees per mouse movement
    public static final double DEFAULT_MOUSE_HORIZONTAL_TRANSLATE_MAX_VALUE = 0.2; // Speed in degrees per mouse movement
    ...
    public static final double DEFAULT_MOUSE_WHEEL_VERTICAL_TRANSLATE_VALUE = 0.1; // Speed in log-meters per wheel movement
    public static final double DEFAULT_MOUSE_WHEEL_VERTICAL_TRANSLATE_VALUE_OSX = 0.01; // Speed in log-meters per wheel movement
    ...
    public ArrayList getModifierActionList(Object device, Integer modifier)
    {
    ...
    protected void setDeviceModifierActionMaps()
    {
        ...
        this.addAction(DEVICE_KEYBOARD, KeyEvent.CTRL_DOWN_MASK | KeyEvent.ALT_DOWN_MASK, VIEW_VERTICAL_TRANS_KEYS_SLOW_CTRL,
            this.makeSlowActionAttributes(this.getActionAttributes(
                DEVICE_KEYBOARD, VIEW_VERTICAL_TRANS_KEYS_CTRL), DEFAULT_SLOW_VALUE));
        this.addAction(DEVICE_KEYBOARD, KeyEvent.CTRL_DOWN_MASK | KeyEvent.ALT_DOWN_MASK, VIEW_VERTICAL_TRANS_KEYS_SLOW_META,
            this.makeSlowActionAttributes(this.getActionAttributes(
                DEVICE_KEYBOARD, VIEW_VERTICAL_TRANS_KEYS_CTRL), DEFAULT_SLOW_VALUE));
        ...
        this.addAction(DEVICE_KEYBOARD, ActionAttributes.NO_MODIFIER, VIEW_RESET_HEADING,
            new ActionAttributes(resetHeadingEvents, ActionAttributes.ActionTrigger.ON_PRESS, 0,
                DEFAULT_KEY_ROTATE_MIN_VALUE, DEFAULT_KEY_ROTATE_MAX_VALUE,
                DEFAULT_ROTATE_SMOOTHING_ENABLED, DEFAULT_ROTATE_SMOOTHING_VALUE));
        // Reset Heading and Pitch Action
        this.addAction(DEVICE_KEYBOARD, ActionAttributes.NO_MODIFIER, VIEW_RESET_HEADING_PITCH,
            new ActionAttributes(resetHeadingPitchEvents, ActionAttributes.ActionTrigger.ON_PRESS, 0,
                DEFAULT_KEY_ROTATE_MIN_VALUE, DEFAULT_KEY_ROTATE_MAX_VALUE,
                DEFAULT_ROTATE_SMOOTHING_ENABLED, DEFAULT_ROTATE_SMOOTHING_VALUE));
        // Stop View Action
