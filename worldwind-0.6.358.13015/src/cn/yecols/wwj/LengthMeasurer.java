 ...
 * @version $Id: LengthMeasurer.java 8282 2008-12-27 02:16:20Z patrickmurris $
 * @see MeasureTool
 */
public class LengthMeasurer implements MeasurableLength
{
    ...
    public void addLine(LatLon begin,LatLon end){
    	this.positions.add(new Position(begin, 0));
    	this.positions.add(new Position(end,0));
    	//this.positions.
    	clearCachedValues();
