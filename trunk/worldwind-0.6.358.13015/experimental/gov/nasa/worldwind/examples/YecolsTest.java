 ...
 * @version $Id: SurfaceObjects.java 12394 2009-07-24 00:43:46Z patrickmurris $
 */
public class YecolsTest extends ApplicationTemplate
{
    private static class AppFrame extends YecolsApplicationTemplate.AppFrame
    {
 ...
 //                               AppFrame.this.highlight(pol.getTopObject());
                    ...
                    if(event.getEventAction().equals(SelectEvent.LEFT_DOUBLE_CLICK)){
                    	System.out.println("click"+event.getTopObject().toString());
                    }
                }
            });
/*
...
/*        private class CustomMarker extends BasicMarker implements PreRenderable, Renderable, Movable
    ...
    public static void main(String[] args)
    {
        ...
        YecolsApplicationTemplate.start("World Wind Surface Objects", AppFrame.class);
    }
}
