...
/**
 * @author dcollins
 * @version $Id: ProgressAnnotation.java 10542 2009-04-27 17:28:30Z dcollins $
 */
public class ProgressAnnotation extends ScreenAnnotation
{
        ...
        Position pickPosition)
    {
        ...
        this.setDrawColor(dc, this.getOutlineColor(), opacity,
        ...
        Position pickPosition)
    {
        ...
        this.setDrawColor(dc, this.getInteriorColor(), opacity,
