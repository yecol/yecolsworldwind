 ...
 *
 * @author dcollins
 * @version $Id: ElevationModelConfiguration.java 13009 2010-01-15 19:25:31Z dcollins $
 */
public class ElevationModelConfiguration extends BasicDataConfiguration
{
     ...
     */
    public static AVList getWMSElevationModelParams(Capabilities caps, String[] formatOrderPreference, AVList params)
    {
        if (caps == null)
        {
        ...
        if (params.getValue(AVKey.PIXEL_TYPE) == null)
        {
            ...
            if (imageFormat != null)
            {
                if (imageFormat.equals("application/bil32"))
                    ...
                    params.setValue(AVKey.PIXEL_TYPE, AVKey.INT16);
                else if (imageFormat.equals("image/bil"))
                    params.setValue(AVKey.PIXEL_TYPE, AVKey.INT16);
            }
        }
