...
/**
 * @author dcollins
 * @version $Id: TiledSurfaceObjectRenderer.java 12869 2009-12-09 05:13:27Z tgaskins $
 */
public class TiledSurfaceObjectRenderer
{
    ...
    protected void beginRendering(DrawContext dc, OGLStackHandler ogsh)
    {
        ...
        int attribBits = stateSupport.getAttributeBits()
        ...
        Sector sector, int x, int y, int width, int height)
    {
        ...
        stateSupport.setColor(Color.GREEN);
