...
/**
 * @author tag
 * @version $Id: ImageUtil.java 12928 2009-12-16 04:50:02Z tgaskins $
 */
        ...
        Sector sector)
    {
        ...
        for (int j = 0; j < height; j++)
        {
            ...
            for (int i = 0; i < width; i++)
            {
                ...
                {
//                    if (cell.uv[0] < 0 || cell.uv[1] < 0)
//                        System.out.printf("LESS THAN ZERO %f, %f\n", cell.uv[0], cell.uv[1]);
//
...
//                    if (c.getRed() > 0 && c.getGreen() / c.getRed() > 5)
//                    {
//                        System.out.printf("(%s, %s, %s\n", c, lat, lon);
//                        ImageInterpolator.ContainingCell cell2 = grid.findContainingCell(lon, lat);
//
//                        int cr = interpolateColor(cell.uv[0], cell.uv[1],
//                            sourceColors[cell.fieldIndices[0]],
//                            sourceColors[cell.fieldIndices[1]],
//                            sourceColors[cell.fieldIndices[3]],
//                            sourceColors[cell.fieldIndices[2]]
