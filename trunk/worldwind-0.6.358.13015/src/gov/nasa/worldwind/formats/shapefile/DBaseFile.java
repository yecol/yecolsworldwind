 ...
 * @version $Id: DBaseFile.java 12796 2009-11-14 23:37:46Z patrickmurris $
 */
public class DBaseFile
{
    ...
    protected List<DBaseRecord> readRecordsFromFile(File file) throws IOException
    {
        ...
        {
            is = new BufferedInputStream(new FileInputStream(file));
            ShapefileUtils.skipBytes(is, this.header.headerLength); // Skip over header
...
//    {
//        File file = new File("J:\\Data\\Shapefiles\\France\\places.dbf");
//        try
//        {
