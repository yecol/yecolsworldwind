 ...
 *
 * @author dcollins
 * @version $Id: TABRasterReader.java 9306 2009-03-11 20:05:32Z tgaskins $
 */
public class TABRasterReader
{
    ...
    public RasterControlPointList read(String path) throws java.io.IOException
    {
        ...
        try
        {
            ...
            {
                workingDirectory = this.getWorkingDirectory(path);
            }
        ...
        if (line != null && line.startsWith(TAG_FILE))
        {
                ...
                || controlPoints.getStringValue(IMAGE_PATH).length() == 0)
            {
                ...
                if (tokens.length >= 2 && tokens[1] != null)
                {
                    ...
                    controlPoints.setValue(IMAGE_PATH, appendPathPart(workingDirectory, pathname));
                }
            }
        }
    ...
    protected String getWorkingDirectory(String path)
    {
