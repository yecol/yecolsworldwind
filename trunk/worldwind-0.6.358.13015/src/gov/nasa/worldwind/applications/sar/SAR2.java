...
import gov.nasa.worldwind.applications.sar.tracks.*;
...
/**
 * @author tag
 * @version $Id: SAR2.java 11816 2009-06-22 22:59:35Z dcollins $
 */
...
//            System.out.println("SAR2.updateToolBar for event: " + event.getPropertyName() + ", new value = " + (event.getNewValue() == null ? "" : "'" + event.getNewValue() + "'"));
    ...
    {
        String imagePath = "gov/nasa/worldwind/applications/sar/images/" + imageName;
