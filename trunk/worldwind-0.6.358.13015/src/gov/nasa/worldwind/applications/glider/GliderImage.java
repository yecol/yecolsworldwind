...
/**
 * @author tag
 * @version $Id: GliderImage.java 12822 2009-11-24 00:22:23Z tgaskins $
 */
public class GliderImage extends AVListImpl
{
     ...
     *                     as the name.
     * @param alignedImage An {@link ImageUtil.AlignedImage} containing a {@link BufferedImage} and a {@link Sector}
     *                     specifying the image and the location to place it.The image will be stretched as necessary to
     *                     fully fill the region.
     * @param altitude     The altitude at which to display the image. Specify 0 to have the image draped over the
     *                     globe's surface.
     *
     * @throws IllegalArgumentException if any of the first three arguments are null.
...
//        GliderImage oldImage = new GliderImage(this);
    ...
    {
        return ImageUtil.alignImage(sourceImage, latitudes, longitudes, null);
    }
