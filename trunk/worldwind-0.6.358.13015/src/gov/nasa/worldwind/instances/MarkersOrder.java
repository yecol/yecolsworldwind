 ...
 * @version $Id: MarkersOrder.java 12848 2009-12-01 01:25:12Z dcollins $
 */
public class MarkersOrder extends ApplicationTemplate
{
    ...
    private static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        private final PowerOfTwoPaddedImage dayOfWeekLegend = createLegendForDaysOfWeek(attrsDayOfWeek);
        private final PowerOfTwoPaddedImage hoursLegend = createLegendForHours(attrsHours);
        ...
        private PowerOfTwoPaddedImage createLegendForHours(MarkerAttributes[] attrs)
        {
        ...
        private PowerOfTwoPaddedImage createLegendForDaysOfWeek(MarkerAttributes[] attrs)
        {
        ...
        private void updateScreenAnnotation(PowerOfTwoPaddedImage image)
        {
