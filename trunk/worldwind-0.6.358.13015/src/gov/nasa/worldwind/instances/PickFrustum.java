...
/**
 * @author Jeff Addison
 * @version $Id: PickFrustum.java 12668 2009-09-28 23:08:31Z jaddison $
 */
public class PickFrustum extends ApplicationTemplate
{
    ...
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        private PickFrustumLayer frustumLayer = new PickFrustumLayer();
        ...
        public AppFrame()
        {
            ...
            for (int x = -180; x < 180; x += 5)
            {
                ...
                {
                    UserFacingIcon icon = new UserFacingIcon("src/images/georss.png",
